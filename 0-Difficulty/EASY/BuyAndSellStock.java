...
class BuyAndSellStock {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Maximum profit for prices1: " + solution.maxProfit(prices1)); // Output: 5

        int[] prices2 = {7, 6, 4, 3, 1};
        System.out.println("Maximum profit for prices2: " + solution.maxProfit(prices2)); // Output: 0
    }
}
